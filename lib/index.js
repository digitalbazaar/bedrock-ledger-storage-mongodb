...
async function _createCoreIndexes(
  ...
  await brCreateIndexes([{
    ...
    options: {unique: true, background: false, name: 'event_core_1'}
  }, {
    collection: eventCollection,
    fields: {'meta.consensus': 1, 'event.type': 1, 'meta.blockHeight': 1,
      'meta.blockOrder': 1},
    options: {unique: true, background: false, name: 'event_core_2',
    ...
    options: {unique: false, background: false, name: 'event_core_2.1'}
  }, {
    collection: eventCollection,
    fields: {'event.type': 1, 'meta.created': 1},
    options: {unique: false, background: false, name: 'event_core_3'}
  }, {
    collection: eventCollection,
    fields: {'event.type': 1, 'meta.consensusDate': 1},
    options: {unique: false, background: false, name: 'event_core_4'}
  }, {
    collection: eventCollection,
    fields: {'meta.eventHash': 1, 'meta.blockHeight': 1},
    options: {unique: true, background: false, name: 'event_core_5',
      partialFilterExpression: {'meta.blockHeight': {$gte: 0}}
    }
  }, {
    collection: blockCollection,
    fields: {id: 1},
    options: {unique: true, background: false, name: 'block_core_1'}
  }, {
    collection: blockCollection,
    fields: {'block.blockHeight': 1},
    options: {unique: false, background: false, name: 'block_core_2'}
  }, {
    collection: blockCollection,
    fields: {'block.type': 1, 'block.blockHeight': 1},
    options: {unique: false, background: false, name: 'block_core_3'}
  }, {
    collection: blockCollection,
    fields: {'meta.blockHash': 1},
    options: {unique: true, background: false, name: 'block_core_4'}
  }, {
    collection: blockCollection,
    fields: {'meta.consensus': 1, 'block.blockHeight': 1,
      'block.previousBlockHash': 1},
    options: {unique: true, background: false, name: 'block_core_7'}
  }, {
    collection: operationCollection,
    fields: {
      'meta.eventHash': 1, 'meta.eventOrder': 1, 'meta.operationHash': 1
    },
    options: {unique: true, background: false, name: 'operation_core_1'}
  }, {
    collection: operationCollection,
    fields: {'recordId': 1},
    options: {unique: false, background: false, name: 'operation_core_2'}
  }]);
}
